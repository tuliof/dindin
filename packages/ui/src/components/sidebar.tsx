...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@dindin/ui/components/sheet";
...
import { useIsMobile } from "@dindin/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: The sidebar state must persist in a browser cookie.
