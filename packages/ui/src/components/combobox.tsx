/* biome-ignore-all lint/performance/noNamespaceImport: Base UI's combobox context requires the React namespace type helpers. */
/* biome-ignore-all lint/suspicious/noLeakedRender: Boolean component options are intentional render guards. */
